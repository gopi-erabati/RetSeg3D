# modified from mmdet3d/datasets/trasnforms/loading.py
...
class LoadAnnotations3DWaymoSemantic(LoadAnnotations):
    """Load Annotations3D.
    ...
    def _load_semantic_seg_3d(self, results: dict) -> dict:
        ...
        if self.dataset_type == 'waymo':
            pts_semantic_mask = pts_semantic_mask.reshape(-1, 2)[:, 1]
