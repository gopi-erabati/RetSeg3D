# Modified from mmdet3d/models/decode_heads/cylinder3d_head.py
...
class RetSeg3DHead(Base3DDecodeHead):
    """RetSeg3D decoder head.

    Decoder head used in `RetSeg3D'
    ...
    Args:
        ...
        loss_decode (dict or :obj:`ConfigDict`): Config of CrossEntropy loss.
            Defaults to dict(
    ...
    def __init__(self,
        ...
        super(RetSeg3DHead, self).__init__(
            channels=channels,
